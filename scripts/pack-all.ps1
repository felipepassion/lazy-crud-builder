...
$projects = @(
  ...
  'src/CrossCutting/CrossCutting.Utils/Lazy.Crud.CrossCuting.Infra.Utils.csproj',
  ...
  'src/Builder/Builder.Infra.Core.Data/Lazy.Crud.Builder.Infra.Data.csproj',
  'src/CrossCutting/CrossCutting.Infra.Log/Lazy.Crud.CrossCutting.Infra.Log.csproj',
  'src/CrossCutting/CrossCutting.Application.Mail/ClassLibrary1/Lazy.Crud.CrossCutting.Application.Mail.csproj'
)
