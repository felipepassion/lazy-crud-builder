...
namespace LazyCrudBuilder.SystemSettings.Application.DTO.Aggregates.SystemSettingsAgg.Requests 
{
 ...
 [H2("Grupo de Menus / Painéis")]     public partial class SystemPanelGroupListiningDTO : SteppableEntityDTO
	{
         [DisplayOnList,DisplayName("Description"),Title] public  string Description { get; set; }[DisplayOnList,DisplayName("Code"),Subtitle] public  string Code { get; set; }[DisplayOnList,DisplayName("Menus")] public List<LazyCrudBuilder.SystemSettings.Application.DTO.Aggregates.SystemSettingsAgg.Requests.SystemPanelListiningDTO> SubItems { get; set; } = new List<LazyCrudBuilder.SystemSettings.Application.DTO.Aggregates.SystemSettingsAgg.Requests.SystemPanelListiningDTO>();     }
